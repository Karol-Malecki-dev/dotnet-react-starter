...
/// </summary>
public sealed class ListProjectTasksHandler : IRequestHandler<ProjectTaskQuery, ProjectOperationResult<PagedProjectTaskView>>
{
    ...
    public async Task<ProjectOperationResult<PagedProjectTaskView>> Handle(
