...
/// <summary>
/// EF Core implementation of the list-project-tasks persistence port.
/// </summary>
public sealed class EfProjectTaskQueryStore : IListProjectTasksQueryStore
{
