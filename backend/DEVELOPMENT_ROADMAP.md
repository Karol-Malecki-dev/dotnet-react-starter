...
| V3 | 40% | Project and ProjectTask aggregate boundaries are documented and tested; invitation transactions and PostgreSQL concurrency tests are in place; implementation is not complete. |
