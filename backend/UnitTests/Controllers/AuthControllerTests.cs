...
public class AuthControllerTests
{
    ...
    public async Task Login_Returns_ok_when_credentials_are_valid()
    {
        ...
        var user = new User { Id = Guid.NewGuid(), Email = dto.Email, DisplayName = "Test", Role = UserRole.User, IsEmailConfirmed = true, IsTwoFactorEnabled = false };
    ...
    public async Task Register_Returns_created_when_registration_succeeds()
    {
        ...
        var user = new User { Id = Guid.NewGuid(), Email = dto.Email, DisplayName = "New User", Role = UserRole.User, IsEmailConfirmed = false };
    ...
    public async Task VerifyTwoFactor_Returns_ok_when_code_is_valid()
    {
        ...
        var user = new User { Id = Guid.NewGuid(), Email = "2fa@example.com", DisplayName = "Two Factor", Role = UserRole.User };
        var tokens = new JwtTokens { AccessToken = "access-token", RefreshToken = "refresh-token", ExpiresIn = 900 };
